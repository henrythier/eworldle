...
export const StatsModal = ({
  ...
  return (
    ...
    >
      <StatBar gameStats={gameStats} />
      <h4 className="text-lg leading-6 font-medium text-neutral-800 dark:text-gray-100">
        {GUESS_DISTRIBUTION_TEXT}
      </h4>
      <Histogram
        gameStats={gameStats}
      ...
      {(isGameLost || isGameWon) && (
        <div className="mt-5 sm:mt-6 columns-2 dark:text-white">
          <div>
            <h5>{NEW_WORD_TEXT}</h5>
            <Countdown
              className="text-lg font-medium text-neutral-800 dark:text-gray-100"
              date={tomorrow}
              daysInHours={true}
            />
          </div>
          <a href="https://calendly.com/grid-x/gridx-e-world?month=2022-06">
          <button
            type="button"
